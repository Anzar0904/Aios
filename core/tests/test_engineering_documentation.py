...
def test_service_evaluation_flow():
    ...
    # Publish
    report = EngineeringDocumentationReport("r1", "ws_1", "Executive summary content", "Low risk assessment", 0.0, ["rec1"])
...
def test_backward_compatibility():
    ...
    errors = validator.validate_engineering_document(EngineeringDocumentArtifact("a1", "ws_1", "", 0.0, []))
