...
def test_readme_planner():
    ...
    template = READMETemplate(
        template_id="t1", sections_order=["Overview", "Installation", "License"], style_rules={}
    )
    report = MagicMock()
...
def test_readme_updating():
    ...
    changes = [READMESection("Overview", "New intro", 0), READMESection("License", "MIT", 2)]
...
def test_service_evaluation_flow():
    ...
    template = READMETemplate(template_id="t1", sections_order=["Overview"], style_rules={})
