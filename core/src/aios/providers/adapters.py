...
class MockProvider(AIProvider):
    ...
    def name(self) -> str:
        return "mock"
    def generate(self, model: str, prompt: str, system_prompt: Optional[str] = None, **kwargs: Any) -> str:
        res = f"[MockProvider] Response to prompt: '{prompt}'"
        if system_prompt:
            res = f"System: {system_prompt}\n{res}"
        return res
    def stream(self, model: str, prompt: str, system_prompt: Optional[str] = None, **kwargs: Any) -> Iterator[str]:
...
class GeminiProvider(AIProvider):
    ...
    def generate(self, model: str, prompt: str, system_prompt: Optional[str] = None, **kwargs: Any) -> str:
        return f"[GeminiProvider] response"
