"""
Diagram Generator CLI — python -m aios.docgen.diagram_main

Generates architecture diagrams in Mermaid format into docs/diagrams/.
"""
...
def main() -> int:
    ...
    try:
        ...
        # Print summary
        print("=" * 60)
        print("AIOS Architecture Diagram Generator — Sprint 7 Milestone 4")
        print("=" * 60)
        print(f"Status:       {result.status.upper()}")
        print(f"Elapsed:      {result.elapsed:.2f}s")
        print(f"Output:       {project_root / 'docs' / 'diagrams'}")
        print()
