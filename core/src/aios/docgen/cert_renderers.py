...
def render_certification_readme(result: "CertificationResult") -> str:
    ...
    lines = [
        ...
        "",
        f"> **Sprint 7 Milestone 6 — Documentation Certification**  ",
...
def render_certification_report(result: "CertificationResult") -> str:
    ...
    lines = [
        ...
        "",
        f"| Check Category | Errors | Warnings | Passes |",
        f"|----------------|--------|----------|--------|",
    ]
...
def render_completeness_report(result: "CertificationResult") -> str:
    ...
    lines = [
        ...
        "## Summary",
        "",
        f"| Dimension | Present | Required | Score |",
        f"|-----------|---------|----------|-------|",
    ...
    present_sections = [f for f in section_findings if f.severity == Severity.PASS]
    missing_sections = [f for f in section_findings if f.severity == Severity.WARNING]
